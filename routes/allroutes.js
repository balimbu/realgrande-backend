...
const allrouter = express(); // router has the express
// import multer package or moudule to read text from the form
// multer is to handle multipart data, handles both text and multimedia
const multer = require('multer');
let getFields = multer();

// to get all houses
// all router is express
...
allrouter.get("/searchbycounty/:county", async (request, response) => {
...
// always use POST method so that sensitive information or details are not displayed in the browser bar
...
module.exports = allrouter; // export the all routers
